...
window.addEventListener("load", () => {
  ...
  if (!trackEl) { console.error("[drone-scene] #scenes-track not found."); return }
  ...
  const poses = [
    ...
    { cam: new THREE.Vector3(-2.785, 3.265, -0.030), tgt: new THREE.Vector3(-0.238, -0.070, -0.032), fov: 10.5 },  // pose 2
  ]
