...
fe.load(Ue, r => {
    ...
    const M = [
        ...
        { cam: new E(-29.263, 37.163, 0.053),   tgt: new E(0.6, 3.6, 0) },
        { cam: new E(-29.263, 37.163, 0.053),   tgt: new E(0.6, 4.0, 0) },
        { cam: new E(-29.263, 37.163, 0.053),   tgt: new E(0.6, 4.2, 0) },
        { cam: new E(-29.263, 37.163, 0.053),   tgt: new E(0.6, 4.5, 0) }
    ];
    let x = 0, k = 0;
