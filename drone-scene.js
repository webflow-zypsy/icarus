...
;(function () {
  ...
  // ─── ASSET CONFIGURATION — update URLs if you move the files ─────────────
  const DRONE_ASSETS = {
  ...
  if (typeof THREE.RGBELoader === "undefined") {
    console.error("[drone-scene] THREE.RGBELoader not found. Ensure RGBELoader.js is loaded before this script.")
    return
  }
  if (typeof THREE.GLTFLoader === "undefined") {
    console.error("[drone-scene] THREE.GLTFLoader not found. Ensure GLTFLoader.js is loaded before this script.")
    return
  }
  if (typeof THREE.DRACOLoader === "undefined") {
    console.error("[drone-scene] THREE.DRACOLoader not found. Ensure DRACOLoader.js is loaded before this script.")
    return
  }
