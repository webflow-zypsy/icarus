...
window.addEventListener("load", () => {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  const poses = [
    { cam: new THREE.Vector3(-1.482,  1.031, 0.228), tgt: new THREE.Vector3(0.038, 0.061, 0) },  // pose 0 — top of scroll
    { cam: new THREE.Vector3(-2.437,  1.842,  4),     tgt: new THREE.Vector3(0.038, 0.061, 0) },  // pose 1 — mid scroll
    { cam: new THREE.Vector3(-1.829,  2.323,  4.003), tgt: new THREE.Vector3(0.038, 0.061, 0) },  // pose 2 — bottom of scroll
  ]
